...
class CodeNames():
	def __init__(self):
		...
		startpage = tk.Canvas(self.root, height = 600 , width = 500)
		startpage.pack()
		background_image = tk.PhotoImage(file = 'view.png')
		...
		label = tk.Label(frame, text = "AI Codename Game", font = ('Courier', 27), bg = 'white')
		label.place(relwidth = 1, relheight = 1)

		startmenu = tk.Frame(self.root, bg = custom_blue, bd = 5)
		startmenu.place(relx = 0.5, rely = 0.75, relwidth = 0.25, relheight = 0.1, anchor = 'n')

		agent_button = tk.Button(startmenu, text = 'Start Play', bg = 'white', font = ('Courier', 15), command = lambda: start_game())
		agent_button.place(relx = 0, rely = 0, relwidth = 1, relheight = 1)
